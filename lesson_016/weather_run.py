...
#     WeatherHandler('אילת', '14-10-2020', is_write_db=True, is_read_db=True, is_console_out=True).run()
#
#     WeatherHandler('Нижний Новгород', '01-12-2019', '10-12-2019', is_write_db=True, is_card=True, is_read_db=True,
